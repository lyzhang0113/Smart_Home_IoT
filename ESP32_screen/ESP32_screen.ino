...
*/
   ...
   "Device2",         // TestClient, Client name that uniquely identify your device 
   1883               // Port number
...
void onConnectionEstablished() {
  ...
  client.subscribe("Room_LCD", onTestMessageReceived);
  //Topic to be changed according to room/sensor type
  //client.publish("Room_LCD", "Start working");
}
...
void loop() {
  ...
  if (flag == 1){
    ...
    tmp = String(humi);
    lcd.setCursor(0,1);
    Serial.println("humi: "+tmp);
    lcd.print("humi: "+tmp+"%");
    tmp = String(temp);
    delay(10);
    lcd.setCursor(0,0);
    Serial.print("temp: "+tmp);
    lcd.print("temp: "+tmp+" C");
    flag = 0;
  }
  delay(10);
